...
import { OrbitalBackground, StarField } from '@/components/ui/orbital-background'
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen text-white overflow-x-hidden">
      ...
      <OrbitalBackground particleCount={60} />
      ...
      <nav className="glass-nav fixed top-4 left-1/2 transform -translate-x-1/2 z-50 px-8 py-4 w-11/12 max-w-6xl">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <span className="text-napoleon text-2xl">Napoleon</span>
          </motion.div>
          ...
          >
            <a href="#features" className="text-luxury-body hover:text-white transition-all duration-300">
              Features
            </a>
            <a href="#testimonials" className="text-luxury-body hover:text-white transition-all duration-300">
              Testimonials
            </a>
            <a href="#pricing" className="text-luxury-body hover:text-white transition-all duration-300">
              Pricing
            </a>
            <a href="#contact" className="text-luxury-body hover:text-white transition-all duration-300">
              Contact
            </a>
        ...
        <div className="text-center max-w-4xl mx-auto relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-luxury-body">Trusted by Fortune 500 executives</span>
            </motion.div>
            ...
            >
              <span className="text-napoleon block mb-4">Napoleon AI</span>
              <span className="text-luxury-headline font-headline text-4xl md:text-6xl block">
            ...
            <motion.p
              variants={fadeInUp}
              className="text-luxury-body text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed"
            >
            ...
            >
              <button className="btn-luxury-outline flex items-center gap-3 text-lg px-8 py-4">
              ...
              <ClerkAuthButton 
                variant="primary" 
                size="lg" 
                className="btn-luxury-primary text-lg px-8 py-4"
              >
            ...
            <motion.div
              variants={fadeInUp}
              className="pt-16 flex flex-col md:flex-row items-center justify-center gap-8 text-sm text-luxury-body"
            >
      ...
      <section id="features" className="py-32 px-6 relative">
        <div className="max-w-6xl mx-auto">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-luxury-headline font-headline text-4xl md:text-6xl mb-6">
              Executive-Grade Intelligence
            </h2>
            <p className="text-luxury-body text-xl max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="glass-card p-8 will-change-transform"
              >
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-luxury-headline font-headline text-2xl mb-4">{feature.title}</h3>
                    <p className="text-luxury-body leading-relaxed">{feature.description}</p>
                  </div>
                </div>
              </motion.div>
            ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="glass-card p-8 text-center will-change-transform"
              >
                <div className="mb-6">
                  {[...Array(5)].map((_, i) => (
                ...
                <blockquote className="text-luxury-body text-lg mb-8 leading-relaxed italic">
                ...
                <div className="border-t border-white/10 pt-6">
                  ...
                  <div className="text-luxury-body text-sm">
                    {testimonial.title}
                  </div>
                </div>
              </motion.div>
      ...
      <section className="py-32 px-6 relative">
        ...
        >
          ...
          <h2 className="text-napoleon text-5xl md:text-6xl mb-8">
            Join the Elite
          </h2>
          
          <p className="text-luxury-body text-xl mb-12 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <ClerkAuthButton 
              variant="primary" 
              size="lg" 
              className="btn-luxury-primary text-xl px-12 py-4"
            >
              Begin Executive Access
            </ClerkAuthButton>
            
            <button className="btn-luxury-outline text-xl px-12 py-4 flex items-center gap-3">
          ...
          <div className="flex items-center justify-center gap-8 text-luxury-body mt-12 text-sm">
            <div className="flex items-center gap-2">
              <Shield className="w-4 h-4 text-blue-400" />
          ...
          <div className="glass-card p-12">
            <div className="flex flex-col md:flex-row items-center justify-between mb-8">
              ...
              >
                ...
                <div>
                  <span className="text-napoleon text-xl">Napoleon AI</span>
                  <div className="text-luxury-body text-sm">Executive Intelligence Platform</div>
                </div>
              </motion.div>
              
              <div className="flex items-center gap-8 text-luxury-body">
            ...
            <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between">
              <div className="text-luxury-body text-sm mb-4 md:mb-0">
                © 2024 Napoleon AI. Crafted for executive excellence.
              </div>
              
              <div className="flex items-center gap-6 text-luxury-body text-sm">
                <div className="flex items-center gap-2">
