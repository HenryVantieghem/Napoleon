      ...
      <nav className="relative z-10 flex items-center justify-between p-6 lg:p-8">
        ...
        <SignedOut>
          <SignInButton mode="modal">
            <button className="text-white hover:bg-white/10 border border-white/20 px-4 py-2 rounded">
              Sign In
            </button>
          </SignInButton>
        </SignedOut>
        <SignedIn>
          <button 
            ...
            className="text-white hover:bg-white/10 border border-white/20 px-4 py-2 rounded"
          >
            Dashboard
          </button>
        </SignedIn>
      ...
      <div className="relative z-10 container mx-auto px-6 py-20 lg:py-32">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <SignedOut>
              <SignInButton mode="modal">
                <button className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-8 py-4 text-lg font-semibold rounded-xl shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 transform hover:scale-105">
